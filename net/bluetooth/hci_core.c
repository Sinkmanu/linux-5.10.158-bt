...
struct hci_dev *hci_alloc_dev(void)
{
	...
	hci_init_sysfs(hdev);
	discovery_init(hdev);
	printk(KERN_INFO "NIAP-CC: hci_alloc_dev;  smp_max_enc_key_size = %d\n",  smp_max_enc_key_size);
	printk(KERN_INFO "NIAP-CC: hci_alloc_dev;  hdev->le_max_enc_key_size = %d\n",  hdev->le_max_key_size);
