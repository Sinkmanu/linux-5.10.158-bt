		       ...
		       const struct usb_device_id *id)
{
	...
	// NIAP-CC: Reading btusb
	printk(KERN_INFO "NIAP-CC: btusb  hdev->max_enc_key_size = %d\n",  hdev->max_enc_key_size);
	...
	if (id->driver_info & BTUSB_INTEL) {
		printk(KERN_INFO "NIAP-CC: btusb BTUSB_INTEL\n");
		hdev->manufacturer = 2;
	...
	if (id->driver_info & BTUSB_INTEL_NEW) {
		printk(KERN_INFO "NIAP-CC: btusb BTUSB_INTEL_NEW\n");
		hdev->manufacturer = 2;
	...
	if (id->driver_info & BTUSB_CSR) {
		printk(KERN_INFO "NIAP-CC: btusb BTUSB_CSR\n");		
